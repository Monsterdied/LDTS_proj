...
public class LanternaGUI implements GUI {
    ...
    private Terminal createTerminal(int width, int height, AWTTerminalFontConfiguration fontConfig) throws IOException {
        TerminalSize terminalSize = new TerminalSize(width+13, height + 1);
    ...
    @Override
    public void drawTurret(Position position) {drawCharacter(position.getX(), position.getY(), '#', "#FFD700");

    }

    @Override
    public void drawBallon(Position position) {drawCharacter(position.getX(), position.getY(), 'E', "#FFD700");
    ...
    @Override
    public void drawText(org.example.tower_defense.model.Position position, String text, String color) {
        TextGraphics tg = screen.newTextGraphics();
        tg.setForegroundColor(TextColor.Factory.fromString(color));
        tg.putString(position.getX(), position.getY(), text);
    }
